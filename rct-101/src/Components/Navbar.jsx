    ...
    <>
      <Box bg='blackAlpha.800' px={4}>
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          ...
          <Box>
              <Menu>
              <MenuButton ml={7} color="white" variant={'link'} as={Button} rightIcon={<ChevronDownIcon />}>AED</MenuButton>
              <MenuList >
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            ...
            <FormControl mt={13} >
              ...
              <Input width="100%" name="email" value={formstate.email} placeholder='Email Address' type="email" onChange={handleChange}  required />
